...
public:
    enum {
        ...
        FT_LEAF_NODES_CLONED,
        FT_NONLEAF_NODES_CLONED,
        FT_LEAF_NODE_CLONE_TIME,
        FT_NONLEAF_NODE_CLONE_TIME,
        FT_LEAF_NODE_CLONE_PARTITION_TIME,
        FT_NONLEAF_NODE_CLONE_PARTITION_TIME,
        FT_LEAF_NODE_REBALANCES_SKIPPED,
        FT_LEAF_NODE_REBALANCE_TIME,
        FT_STATUS_NUM_ROWS
    };
